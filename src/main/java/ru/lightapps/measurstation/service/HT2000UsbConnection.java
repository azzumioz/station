...
import org.usb4java.*;
import ru.lightapps.measurstation.exception.UsbException;
...
public class HT2000UsbConnection {
    ...
    private static final short USB_VENDOR_ID = 0x10c4;
    private static final short USB_PRODUCT_ID = (short) 0x82cd;
